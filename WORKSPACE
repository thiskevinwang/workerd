...
http_archive(
    name = "capnp-cpp",
    integrity = "sha256-zfA/ZdBdpb9cf79Ww81MfekvEDRyYXpGZPOuQgDZqQg=",
    strip_prefix = "capnproto-capnproto-0fb35b9/c++",
    type = "tgz",
    urls = ["https://github.com/capnproto/capnproto/tarball/0fb35b961c2350f5dfa76f757db69c464f4a778c"],
)
